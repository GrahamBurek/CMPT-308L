...
player_1_pid INT NOT NULL UNIQUE references Players(pid),
player_2_pid INT NOT NULL UNIQUE references Players(pid),
tid INT NOT NULL UNIQUE references Tournament(tid),
...
(
pid INT NOT NULL UNIQUE references Players(pid),
tid INT NOT NULL UNIQUE references Tournament(tid),
PRIMARY KEY(pid,tid)
);
